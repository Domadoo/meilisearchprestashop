...
class MeiliSearchIndexController extends FrameworkBundleAdminController
{
    ...
    public function indexProductsAction()
    {
        ...
        foreach ($languages as $language) {
            ...
            $this->module->requestCurl($meiliUrl . 'indexes/' . Configuration::get('MEILISEARCHPRESTASHOP_PREFIX') . 'products_' . $iso_code . '/settings/filterable-attributes', json_encode(['id_manufacturer', 'out_of_stock', 'condition', 'id_category_default', 'quantity', 'feature_values', 'visibility', 'available_for_order']), 'PUT');
        }
